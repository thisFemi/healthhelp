...
class DateUtil {
  ...
  static List<DateTime> generateAvailableDays(AvailabilityDuration duration) {
    final List<DateTime> availableDays = [];
    final DateTime now = DateTime.now();
    final DateTime startDate =
        now.add(Duration(days: 1)); // Start from the next day
    DateTime endDate;
